...
def init_db():
  ...
  if conn:
    ...
    for col_name, col_type in required_columns.items():
      if col_name not in columns:
        try:
          ...
          logger.warning(
              f"Could not add column {col_name}: {ex}"
          )
    ...
    try:
      ...
      cursor.execute(
          "CREATE INDEX IF NOT EXISTS "
          "idx_reels_posts_username "
          "ON reels_posts(username)"
      )

    except Exception as ex:
      logger.warning(
          f"Could not create indexes: {ex}"
      )
    ...
    if cursor.fetchone()[0] == 0:
      ...
      demo_users = [
          (
              ...
              "Saraah Robotics",
              (
                  "Official Saraah Robotics Account 🚀 "
  ...
  if conn:
    ...
    if existing_user:
      ...
      final_full_name = (
          new_full_name
          if new_full_name
          and new_full_name.strip()
          else existing_dict.get(
              "full_name",
              "",
          )
      )
...
# NEW: controls the dedicated fullscreen direct-chat screen
if "chat_live_refresh" not in st.session_state:
  st.session_state.chat_live_refresh = 0
# ==============================================================================
# 2. DYNAMIC THEME & CSS ENGINE
# ==============================================================================
...
.dm-story-ring {{
    ...
    box-shadow:
        ...
        0 4px 18px rgba(255,0,128,0.18);
}}
  ...
  with center_col:
    ...
    if st.session_state.auth_mode == "login":
      ...
      with st.form("signup_form"):
        ...
        dob_in = st.text_input(
            "Date of Birth",
            placeholder="YYYY-MM-DD",
        )

        acc_type_in = st.selectbox(
            "Account Type",
            [
                "Public",
                "Private",
...
with header_col1:
  st.markdown(
      """
        <div>
            <h3 style='margin:0; color:#00E676; font-size: 1.4rem;'>
                ⚡ Noob Learning
            </h3>
            <p style='margin:0; font-size: 0.65rem; color:#888;
            letter-spacing:1px;'>
                POWERED BY SARAAH ROBOTICS
            </p>
        </div>
...
with header_col_profile:
  ...
  prof_col_avatar, prof_col_name, prof_col_btn = st.columns(
      [1, 2, 1.5]
  )
  ...
  with prof_col_avatar:
    ...
    if (
        profile_pic_val
        and profile_pic_val.startswith("data:image")
    ):
    ...
    st.markdown(
        ...
        ">
            ...
            <p style="
                font-size:14px;
            ">
                Welcome to <b>Noob Learning</b>!
                Connect with peers, share robotics updates,
                upload reels, and exchange live text,
...
# ==============================================================================
  ...
  sub_tab_watch, sub_tab_create = st.tabs(
      [
          "🎥 Watch Reels",
          "➕ Create Reel",
      ]
...
# ==============================================================================
# TAB 3: CHAT & PRIVATE GROUP SECTION
# ==============================================================================
  ...
  with chat_mode_col1:
    ...
    if st.button(
      ...
      st.session_state.chat_sub_mode = (
          "Direct Messages"
      )
  ...
  if (
    ...
    if (
        st.session_state.active_chat_user
        is None
    ):
      ...
      for p_dict in filtered_peers:
        ...
        peer_pic_val = p_dict.get(
            "profile_pic",
            "",
        )

        peer_user_id = p_dict.get(
            "user_id",
            "N/A",
        )

        unread_count = unread_map.get(
            peer_uname,
            0,
        )


        c_avatar, c_info, c_chat = st.columns(
            [0.8, 4.2, 1]
        )
        ...
        with c_avatar:
          ...
          # Rainbow ring for users who have reels.
        ...
        st.markdown(
            f"""
            <hr style="
                border:0.2px solid {border_color};
                margin:5px 0;
            ">
            """,
            unsafe_allow_html=True,
    ...
    # ==========================================================================
      ...
      c_back, c_logo, c_title, c_del = st.columns(
          [0.8, 0.8, 4, 1]
      )
      ...
      try:
        ...
        # The app still works normally if the
        # optional auto-refresh package isn't installed.
        pass
      ...
      with chat_container:
        ...
        if not messages:
          ...
          st.info(
              f"No messages yet with @{peer_name}. "
              "Say hello!"
          )
      ...
      with st.form(
        ...
        c_input, c_file, c_btn = st.columns(
            [3, 2, 1]
        )
  ...
  # ============================================================================
    ...
    if (
        st.session_state.active_group_chat
        is None
    ):
      ...
      st.markdown(
          """
          <p style="color:#888;">
              Create your own private group and select
              user IDs to add members. Only added members
              can see and join the group!
          </p>
          """,
          unsafe_allow_html=True,
      )
      ...
      if not user_groups:
        ...
        st.info(
            ...
            "Create one above or ask an admin to add you!"
        )
      ...
      for g in user_groups:
        ...
        g_description = g_dict[
            "description"
        ]


        c_ginfo, c_gjoin = st.columns(
            [4, 1]
        )
    ...
    # ==========================================================================
      ...
      if user_role == "Admin":
        ...
        with st.expander(
          ...
          for m_row in current_members:
            ...
            col_mu, col_mr, col_maction = st.columns(
                [2, 1, 2]
            )
      ...
      with st.form(
        ...
        gc_input, gc_file, gc_btn = st.columns(
            [3, 2, 1]
        )
        ...
        if (
          ...
          if g_attached_file:
            ...
            if g_ftype == "image":
              ...
              g_encoded_media = (
                  "data:image/"
                  f"{g_attached_file.type.split('/')[-1]}"
                  f";base64,{g_b64}"
              )
  ...
  st.markdown(
      ...
      ">
          ...
          <p style="
              ...
              font-size:15px;
          ">
              {user.get('bio') or 'No bio added yet.'}
          </p>
    ...
    with st.form(
      ...
      if st.form_submit_button(
        ...
        if updated_ok:
          ...
          st.error(
              f"Failed to update profile: {err_msg}"
          )
